                ...
                <g>
                    <g transform={`translate(${block.location[0]}, ${block.location[1]})`}>
                        ...
                        {status.status.map((state, index) => (
                            <>
                                <circle cx="0" cy="30" r={r} className={(state.state_name === states[1] || state.state_name === states[1]) ? classes.fill : classes.circle} />
                                ...
                                <circle cx="200" cy="30" r={r} className={state.state_name === states[4] ? classes.fill : classes.circle} />
                                <path d="M 100 38 C 100 72, 90 65, 200 65" className={state.state_name === state[3] ? classes.stroke : classes.circle} />
                                <circle cx="200" cy="65" r={r} className={state.state_name === states[4] ? classes.fill : classes.circle} />
                            </>
                        ))}
                    </g>
